...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(7, 0, 4, 12.278324301027668);
     ...
     * max velocity. The theoreticaly maximum velocity is 48.311804525985536 in/s.
     * Just make sure that your bot can actually reach this maximum velocity. Path following will be detrimentally
     * affected if it is aiming for a velocity not actually possible.
     *
     * The maximum acceleration is somewhat arbitrary and it is recommended that you tweak this yourself based on
     * actual testing. Just set it at a reasonable value and keep increasing until your path following starts
     * to degrade. As of now, it simply mirrors the velocity results in 41.065033847087705 in/s/s
     *
     * Maximum Angular Velocity is calculated as: maximum velocity / (trackWidth / 2) * (180 / Math.PI)

     */
    public static DriveConstraints BASE_CONSTRAINTS = new DriveConstraints(
            41.065033847087705, 41.065033847087705, 0.0,
            Math.toRadians(285.1943181818182), Math.toRadians(285.1943181818182), 0.0
    );
