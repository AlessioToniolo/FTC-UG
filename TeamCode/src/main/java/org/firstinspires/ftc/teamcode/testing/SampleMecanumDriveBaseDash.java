...
public class SampleMecanumDriveBaseDash {
    ...
    // Diagonal distance of robot wheels (calculated as hypotenuse of lateral distance and forward distance of robot wheels)
     ...
     */
    public void initialize(boolean runUsingEncoders) {
    ...
    /** turnRight
     * @param deg The degrees to turn right
     * Turns the robot right with PID
     */
    public void turnRight(double deg) {
        double accurateAngle = deg * ((diagonalDistance * Math.PI) / 360);
        double integral = 0;
        double repetitions = 0;

        double targetPosition = countsPerInch * accurateAngle;
    ...
    /** turnLeft
     * @param deg The degrees to turn left
